...
\item[\texttt{string(X)}] Succeeds if \verb|X| is bound to a string.
...
Type guards: \verb|ground|, \verb|known|, \verb|unknown|, \verb|integer|, \verb|number|, \verb|string|, \verb|constant|, \verb|compound|, \verb|tuple|, \verb|list|, \verb|is_list|, \verb|writer|, \verb|reader|. Equality guard: \verb|=?=|.
