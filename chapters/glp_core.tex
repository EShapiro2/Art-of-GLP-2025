...
\mypara{Acyclicity}
The SO invariant prevents the formation of circular terms: since each variable occurs at most once, a variable cannot appear in a term to which it is assigned.
...
\item \verb|integer(X)|, \verb|number(X)|, \verb|atom(X)| --- test for specific types
