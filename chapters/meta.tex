...
\paragraph{The brake command.} When a process receives \verb|[brake|_]| on its control stream, it calls \verb|'_equator'(Eq?)| to trigger the equator. This binds the internal writer, which the controller detects.
