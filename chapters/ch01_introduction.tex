...
\mypara{Part I: Foundations} We begin with logic programs, then extend them to concurrent \GLP, establishing the core concepts of reader/writer pairs, SRSW, and committed choice.

\mypara{Part II: Programming with Streams} We develop techniques for stream programming---the natural idiom for \GLP concurrent computation.

\mypara{Part III: Recursive Programming} We adapt classical recursive programming patterns (lists, sorting, arithmetic) to the \GLP setting.

\mypara{Part IV: Objects and Processes} We show how object-oriented concepts emerge naturally from stream-based programming.

\mypara{Part V: Metaprogramming} We explore programs that manipulate programs---essential for building programming tools within \GLP.

\mypara{Part VI: Grassroots Protocols} We present the culmination: protocols for the grassroots social graph, befriending, social networking, and security.
