...
The base case: $0 \times Y = 0$. The recursive case: $s(X) \times Y = (X \times Y) + Y$. The two body goals spawn concurrently; \verb|plus| suspends on \verb|XY?| until \verb|times| produces a value.
