...
For compound terms, unification proceeds recursively on corresponding arguments.
The overall result is: succeed if all arguments succeed, suspend if any argument
suspends (and none fail), fail if any argument fails.
