...
\paragraph{Channel abstractions.} Bidirectional channels, represented as pairs of streams, provide the foundation for agent interaction. The defined guards \verb|send/3|, \verb|receive/3|, and \verb|new_channel/2| (Chapter~\ref{ch:social-graph}) establish channel-based communication patterns that transfer directly to distributed implementation.
