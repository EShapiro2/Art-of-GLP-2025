...
\paragraph{Agent identity.} In deployment, agents are identified by public keys derived from cryptographic keypairs. In simulation, agents are simply strings: \verb|alice|, \verb|bob|, \verb|carol|. Protocol logic treats identities as opaque values for routing and addressing.
